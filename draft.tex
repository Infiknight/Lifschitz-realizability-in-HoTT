...
Our approach in showing that some $F: C\rightarrow D$ is a map with contractible fibers, is to provide for any $d :D$ some $c :C$ such that $f(c) = d$ and then show that such an $c$ is unique, where $C,D$ are said function types. 
